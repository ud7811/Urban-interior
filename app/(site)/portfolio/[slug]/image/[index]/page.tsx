    ...
    <div className="section">
      <div className="container mx-auto px-4 space-y-6">
        <div className="flex items-center justify-between">
          <Link href={`/portfolio/${params.slug}`} className="inline-flex items-center gap-2 text-sm underline">
        ...
        <div className="flex items-center justify-between">
          <div className="flex gap-2">
            {prevIdx !== null && (
              <Link
                href={`/portfolio/${params.slug}/image/${prevIdx}`}
            ...
            {nextIdx !== null && (
              <Link
                href={`/portfolio/${params.slug}/image/${nextIdx}`}
                className="inline-flex items-center gap-2 rounded-md border px-3 py-2 text-sm hover:bg-[color:var(--accent-1)]"
              >
          ...
          <div className="text-right">
            ...
            {p.description ? <p className="text-sm text-muted-foreground max-w-prose">{p.description}</p> : null}
          </div>
        </div>
      </div>
    </div>
