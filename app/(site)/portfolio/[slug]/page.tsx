          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              ...
              <div className="relative h-56 rounded-xl overflow-hidden">
                <Image src={p.beforeAfter.before.asset.url || "/placeholder.svg"} alt={`${p.title} before`} fill className="object-cover" placeholder="blur" blurDataURL={BLUR_DATA} />
              </div>
            </div>
            <div>
              <div className="text-sm mb-2 font-medium">After</div>
              <div className="relative h-56 rounded-xl overflow-hidden">
                <Image src={p.beforeAfter.after.asset.url || "/placeholder.svg"} alt={`${p.title} after`} fill className="object-cover" placeholder="blur" blurDataURL={BLUR_DATA} />
              </div>
            </div>
          </div>
        ) : null}
